...
export const MARKET_COVERAGE: ComponentMapping[] = [
  ...
  { component: 'AnomalySwimLaneChart', group: 'Observabilité', status: 'fr-ds', inSolutions: ['kibana'], marketNames: 'ML anomaly swim lane' },
  { component: 'FlamegraphChart', group: 'Observabilité', status: 'fr-ds', inSolutions: ['grafana'], marketNames: 'Flame graph' },
  { component: 'TraceWaterfallChart', group: 'Observabilité', status: 'fr-ds', inSolutions: ['grafana'], marketNames: 'Trace waterfall' },
  { component: 'DecompositionTreeChart', group: 'Couche analytique', status: 'fr-ds', inSolutions: ['powerbi'], marketNames: 'Decomposition tree' },
  { component: 'Density2DChart', group: 'Couche analytique', status: 'fr-ds', inSolutions: ['tableau', 'dataiku'], marketNames: 'Density 2D (hexbin/contour non-géo)' },
  { component: 'EventFeedPanel', group: 'Observabilité', status: 'fr-ds', inSolutions: ['newrelic'], marketNames: 'Event feed' },
  { component: 'VectorFieldChart', group: 'Couche analytique', status: 'fr-ds', inSolutions: ['highcharts', 'sas'], marketNames: 'Vector field' },
