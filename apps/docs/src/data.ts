import type { CrossfilterGraph, DataModel, Row } from '@sentropic/dataviz-svelte';
...
// Deterministic pseudo-data (no Math.random — stable build/demo).
...
// Fully-linked cross-filter: a selection in one view narrows the others.
