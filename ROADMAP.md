...
- [~] Flux & part-of-whole (pie plein, funnel, waterfall+variance, treemap, sunburst, sankey, chord, radar, mekko, packed bubbles, rose) — contrats core part/hiérarchie/waterfall/flow/radar/rose/mekko/packed bubbles faits ; wrappers DS Donut/Funnel/Waterfall/Treemap/Sunburst/Sankey/Radar livrés en Svelte/React/Vue ; reste Chord/Mekko/Rose/PackedBubble (composants DS non exposés)
